...
/**
 * Bottom status strip for simulation state and app diagnostics.
 *
 * The bar stays mounted across the full editor shell, which makes it a stable
 * home for the runtime log viewer button on mobile devices.
 */
