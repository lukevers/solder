// Symbol type definitions — shared by all symbol categories.
//
// These types describe the structure of a schematic symbol:
// how it looks on the canvas, where its pins are, and what
// electrical role each pin serves.
