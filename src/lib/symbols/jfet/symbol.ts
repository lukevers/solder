...
/**
 * Shared pin layout for JFET (junction
 * field-effect transistor) variants.
 *
 *            ┌── d (drain)
 *   g ──────┤
 *            └── s (source)
 ...
 * Commonly used in guitar pedal input buffers
 * (e.g. J201, 2N5457).
 */
 ...
 * Less common in effects; used in some boutique
 * designs and current sources.
 */
